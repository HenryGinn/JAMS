CREATE TABLE primary_artist (
	primary_artist_id		INTEGER	PRIMARY KEY AUTOINCREMENT,
	primary_artist_name		TEXT		NOT 	NULL UNIQUE
);
...
CREATE TABLE track (
	...
	FOREIGN KEY (primary_artist_id) REFERENCES
		primary_artist(primary_artist_id) ON DELETE CASCADE,
